...
const pedido1 = new turnos(1, "Pepa Rosas", "Calle Falsa 123", 1122334455, "Si")
const pedido2 = new turnos(2, "Luis Alfonson", "Tupac Amaru 2331", 1199008877, "No")
const pedido3 = new turnos(3, "Cecilia Millan", "Uspallata 664", 1166557744, "Si")
...
function tomarPedido(){
    ...
    let gtiaIngresada = document.getElementById("ingresoturno")
...
btnGuardar.addEventListener('click',()=>{
    tomarPedido()
    const inputs = document.querySelectorAll('#ingresoNombre, #ingresoDireccion,#ingresoTelefono, #ingresoTurno');
...
const cabeceros = ["Id", "Nombre", "Dirección", "Telefono", "turnos"];
function crearTabla(){
